            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        _this.offerShareDataRepository.acceptShareData(searchId, worth)
                            ...
                            var e_2, _a, spidEntry, _b, _c, entry, subscriptionPointer, spid, trans, transactionKey, transactionHash, receipt, trans, transactionKey, transactionHash, receipt, e_2_1, updates_1;
                            var _this = this;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        ...
                                        if (!SubscriptionPointer_1.default.conform(entry[1])) return [3 /*break*/, 6];
