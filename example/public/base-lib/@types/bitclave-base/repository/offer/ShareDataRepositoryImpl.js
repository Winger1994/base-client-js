...
var ShareDataRepositoryImpl = /** @class */ (function () {
    ...
    ShareDataRepositoryImpl.prototype.acceptShareData = function (data, uid, bid, searchId, worth) {
        return __awaiter(this, void 0, void 0, function () {
            var resMap, totalShare, shareValue, transactionValue, user_eth_wallets;
            var _this = this;
            return __generator(this, function (_a) {
                resMap = new Map();
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        _this.offerShareDataRepository.acceptShareData(searchId, worth)
                            ...
                            var e_2, _a, spidEntry, _loop_1, this_1, _b, _c, entry, e_2_1, updates_1;
                            var _this = this;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        _loop_1 = function (entry) {
                                            var subscriptionPointer, spid, trans, transactionKey, transactionHash, trans, transactionKey, transactionHash;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        ...
                                                        if (!SubscriptionPointer_1.default.conform(entry[1])) return [3 /*break*/, 3];
                                                        console.log('create nonce pointer start');
                                                        subscriptionPointer = JSON.parse(entry[1]);
                                                        spid = subscriptionPointer.spid;
                                                        return [4 /*yield*/, this_1.contract.methods.InitTransaction(this_1.userShare * shareValue, this_1.spShare * shareValue).send({ from: this_1.eth_wallets, value: transactionValue })];
                                                    case 1:
                                                        trans = _a.sent();
                                                        transactionKey = trans['events']['TransactionInited']['returnValues']['transKey'];
                                                        transactionHash = trans['transactionHash'];
                                                        return [4 /*yield*/, this_1.contract.methods.AssignUser(transactionKey, user_eth_wallets).send({ from: this_1.eth_wallets })];
                                                    case 2:
                                                        _a.sent();
                                                        // TODO: the schema is not used here
                                                        spidEntry.set(spid, new NoncePointerTuple(entry[0], SharePointer_1.default.generateKey(uid, bid), new NoncePointer_1.default(this_1.getRandomInt(), transactionKey), NoncePointer_1.default.generateKey(uid, spid)));
                                                        console.log('create nonce pointer end');
                                                        this_1.web3.eth.getTransactionReceipt(transactionHash).then(function (receipt) {
                                                            console.log("transaction details for key: " + entry[0]);
                                                            console.log(receipt);
                                                        });
                                                        return [3 /*break*/, 7];
                                                    case 3:
                                                        console.log('do not create nonce pointer start');
                                                        ...
                                                        return [4 /*yield*/, this_1.contract.methods.InitTransaction(transactionValue, 0).send({ from: this_1.eth_wallets, value: transactionValue })];
                                                    case 4:
                                                        trans = _a.sent();
                                                        transactionKey = trans['events']['TransactionInited']['returnValues']['transKey'];
                                                        transactionHash = trans['transactionHash'];
                                                    ...
                                                    case 5:
                                                        _a.sent();
                                                        return [4 /*yield*/, this_1.contract.methods.BusinessConfirm(transactionKey).send({ from: this_1.eth_wallets })];
                                                    case 6:
                                                        _a.sent();
                                                        console.log('do not create nonce pointer end');
                                                        this_1.web3.eth.getTransactionReceipt(transactionHash).then(function (receipt) {
                                                            console.log("transaction details for key: " + entry[0]);
                                                            console.log(receipt);
                                                        });
    ...
    ShareDataRepositoryImpl.prototype.shareWithBusiness = function (key, value, uid) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenPointer, bid, transactionKey;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.profileManager.getData()
                        ...
                        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                            var data, sharePointer, key_1, updates;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        data = entries.get(uid);
                                        if (!(data === undefined)) return [3 /*break*/, 1];
                                        resolve(false);
                                        return [3 /*break*/, 3];
                                    case 1: return [4 /*yield*/, this.contract.methods.AssignSP(transactionKey, this.eth_wallets).send({ from: this.eth_wallets })];
                                    case 2:
                                        _a.sent();
                                                        ...
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                    ...
                                                                    resolve(false);
                                                                    return [3 /*break*/, 3];
                                                                case 1: return [4 /*yield*/, this.contract.methods.SPConfirm(transactionKey).send({ from: this.eth_wallets })];
                                                                case 2:
                                                                    _a.sent();
                                                                    resolve(true);
                                                                    _a.label = 3;
